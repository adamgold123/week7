...
var dares = [];
dares.push("Eat a spoon full of mustard.");
dares.push("Run around in a circle.");
dares.push("Spin around in a circle ten times then try to walk in a straight line.");
